...
const char * const BITCOIN_CONF_FILENAME = "quasar.conf";
const char * const BITCOIN_PID_FILENAME = "quasar.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Quasar";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Quasar";
#else
    // Unix
    return pathRet / ".quasar";
#endif
#endif
}
