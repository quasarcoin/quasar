...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s quasar-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  quasar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quasar transaction") + "\n" +
              "  quasar-tx [options] -create [commands]   " + _("Create hex-encoded quasar transaction") + "\n" +
              "\n";
