...
#man pages
Source20:	https://raw.githubusercontent.com/bitcoin/bitcoin/v%{version}/doc/man/quasard.1
Source21:	https://raw.githubusercontent.com/bitcoin/bitcoin/v%{version}/doc/man/quasar-cli.1
Source22:	https://raw.githubusercontent.com/bitcoin/bitcoin/v%{version}/doc/man/quasar-qt.1
...
# man pages
install -D -p %{SOURCE20} %{buildroot}%{_mandir}/man1/quasard.1
install -p %{SOURCE21} %{buildroot}%{_mandir}/man1/quasar-cli.1
%if %{_buildqt}
install -p %{SOURCE22} %{buildroot}%{_mandir}/man1/quasar-qt.1
%endif
...
%attr(0644,root,root) %{_mandir}/man1/quasar-qt.1*
%endif
...
%attr(0644,root,root) %{_mandir}/man1/quasard.1*
...
%attr(0644,root,root) %{_mandir}/man1/quasar-cli.1*
